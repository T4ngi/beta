...
class AppColor{
  ...
  static Color gradienFirst=const Color(0xff0f17ad);
  static Color gradienSecond=const Color(0xFF6985e8);
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xFF4a90e2); // Contoh warna
  static Color secondPageContainerGradient2stColor = const Color(0xFF50e3c2);
  ...
  static Color circuitColor=const Color(0xFF2f2f51);
